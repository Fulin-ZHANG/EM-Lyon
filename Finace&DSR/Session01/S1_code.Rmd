...
There are two steps: first you need to download the package (only once). The packages are downloaded from servers all around the world. So we start by choosing one.
